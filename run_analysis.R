run_analysis<- function(){
  #Get data from test team, calculate mean and standard deviation and combine them in a dataframe
  ...
  #Get data from train team, calculate mean and standard deviation and combine them in a dataframe
  ...
  #Get the activity labels and the corresponding code, rename columns for readability
